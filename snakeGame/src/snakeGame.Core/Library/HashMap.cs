...
public class HashMap<K, V>
{
    ...
    private DynamicArray<LinkedList<HashNode<K, V>>> buckets;
    ...
    public V Remove(K key)
    {
        ...
        LinkNode<HashNode<K, V>>? removedNode = bucketValues.RemoveLinkNodeAtFirstOccurrence(existingNode.Value);
        Size--;
    ...
    private void ReHash()
    {
        ...
        DynamicArray<LinkedList<HashNode<K, V>>> tempBuckets = new(newCapacity);
        int i;
    ...
    private LinkedList<HashNode<K, V>> GetBucketForKey(K key)
    {
        ...
        LinkedList<HashNode<K, V>> bucketValues = buckets.GetValue(hashCode)
