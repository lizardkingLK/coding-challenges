...
import {
  APP_URL_HOME,
  CODE,
  CODE_VERIFIER_LENGTH, ERROR, KEY_ACCESS_TOKEN,
  KEY_AUTH_TOKEN, KEY_CODE_VERIFIER, KEY_REFRESH_TOKEN,
  SPOTIFY_API_CLIENT_ID, SPOTIFY_API_CODE_CHALLENGE_METHOD,
  SPOTIFY_API_CONTENT_TYPE, SPOTIFY_API_GRANT_TYPE,
  SPOTIFY_API_SCOPE, SPOTIFY_API_URL_AUTHORIZE, SPOTIFY_API_URL_GET_TOKEN
...
export class Authorization {
  ...
  async #authorize() {
    ...
    if (Object.hasOwn(searchParams, CODE)) {
      ...
      this.#navigateToAuthorizationCodeURL();
      return true;
    }
  }
  ...
  async #navigateToAuthorizationCodeURL() {
